...
class ConvLayer2D(object):
    ...
    def forward(self, img):
        ...
        # Reshape the filter weights into a matrix
    ...
    def backward(self, dprev):
        ...
        # Remove the padding from dinput_matrix
        ...
        for n in range(N):
            ...
            for i in range(out_h):
                for j in range(out_w):
                    # Select the pooling region in this input image at this point
                    ...
                    # Compute the max over the pooling region
